...
public class Ejercicio04 {
	...
	public static void main (String[] args){
		...
		System.out.println("El mayor número es : "+elMayor);	
		System.out.println("El menor número es : "+elMenor);	

		for(double i=elMenor; i<elMayor; i++) {						
			System.out.println(i);			
			suma += i;					
		}				
		System.out.println("La suma de todos los números comprendidos entre " +elMayor+ " y " +elMenor+ " es igual a: "+suma);	
	}
}
